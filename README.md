...
**Purpose:** To analyze the results from the generative runs, identify the Pareto front, and calculate performance metrics like hypervolume.
**Instructions:**
1.  Open the notebook.
...
### Step 4: `03_chemical_space_analysis.ipynb`

**Purpose:** To visualize and compare the chemical diversity of the compounds generated by your method versus the baseline.
**Instructions:**
1.  Open the notebook.
2.  Update the input file paths in the **Configuration** cell.
3.  Run all cells.
4.  A t-SNE plot of the chemical space will be saved in `results/`.

### Step 5: `04_downstream_filtering.ipynb`
